...
FFmpeg, the standalone Ollama runtime, Whisper Medium and Whisper Small, Qwen3:4b, and both
Argos translation models. It also bundles Noto Sans CJK SC, Noto Serif CJK SC, and LXGW WenKai
...
- Windows x64 with at least 22 GB free for caches, staging, and output
...
The script pins Python 3.12.10, every Python runtime dependency, both Whisper model revisions,
