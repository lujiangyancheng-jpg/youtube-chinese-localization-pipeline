# Bundled offline models, fonts, and runtimes

The base installer and the separate Whisper model-pack installers redistribute the following
unmodified model artifacts and runtimes. Their full license or attribution text is included beside
this file in the installed `licenses` directory.

| Component | Purpose | License / attribution |
|---|---|---|
| `Systran/faster-whisper-medium` model pack | Higher-quality multilingual English/Chinese speech recognition | MIT; converted from OpenAI Whisper Medium |
| `Systran/faster-whisper-small` model pack | Faster and lower-memory multilingual English/Chinese speech recognition | MIT; converted from OpenAI Whisper Small |
...
| Ollama standalone CLI/runtime | Local Qwen inference | MIT; Copyright Ollama |
