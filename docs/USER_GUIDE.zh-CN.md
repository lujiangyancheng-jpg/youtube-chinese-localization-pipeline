...
把 `YouTube-Chinese-Localizer-0.6.5-Standard-Offline-Setup.exe` 或
`YouTube-Chinese-Localizer-0.6.5-Complete-Offline-Setup.exe` 和同目录下所有 `.bin`
